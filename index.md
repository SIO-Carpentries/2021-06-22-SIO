...
address: "Outdoor tent at parking lot P416 East, UCSD Campus"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
country: "us"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes) for the institution that hosts the workshop
language: "en"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) for the
latitude: "32.8777654"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "-117.2394212"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "Jun 22-25, 2021"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Bia Villas Boas", "Alma Carolina Castillo-Trujillo", "Gui Castelão"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Luke Colosi", "Saulo Soares"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
